...
const Services = () => {
  return (
    <div id='services' className='w-full px-[12%] py-10 scroll-mt-20'>
        ...
        <p className='text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo'>I am a frontend devloper from California, USA with 10 years of experience in multiple companies like microsoft,Tesla and Apple.</p>
